            ...
            <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif">
                <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Always">
                    <ContentTemplate>
                        ...
                        <asp:Panel ID="Panel2" runat="server" CssClass="Popup7" align="center" Style="display: none; background-image: linear-gradient( 135deg, #90F7EC 0%, #32CCBC 100%);">
            ...
            <ContentTemplate>
                ...
                <div class="container-fluid col-lg-12 col-md-12" style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; top: 0px;">
                    ...
                    <div class="form-inline">
                        ...
                        <div class="form-group">
                            <asp:Label runat="server" ID="LBLCHEQUERA21" CssClass="label" Text="-" Font-Size="Small" AutoPostBack="true" BackColor="Black"></asp:Label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6" style="top: 5px; left: -20px;">
                                <asp:Label runat="server" ID="LBLRANGOINI2" CssClass="label" Text="-" Font-Size="Small" AutoPostBack="true" BackColor="Black"></asp:Label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6" style="top: 5px; left: -20px;">
                                <asp:Label runat="server" ID="LBLRANGOFIN2" CssClass="label" Text="-" Font-Size="Small" AutoPostBack="true" BackColor="Black"></asp:Label>
